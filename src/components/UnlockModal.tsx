      ...
      <div className="bg-white w-full sm:w-[360px] sm:rounded-2xl rounded-t-2xl p-5 pb-8 sm:pb-5 animate-slide-up">
        {status === "confirm" && (
          <>
            <div className="flex flex-col items-center gap-3 mb-5">
              ...
              <h3 className="text-base font-bold text-gray-900">맛집 정보를 확인할까요?</h3>
            ...
            <div className="flex items-center justify-between px-1 mb-5">
              ...
              <span className="text-xs text-gray-500">{userPoints}P → {userPoints - 5}P</span>
            </div>
        ...
        {status === "loading" && (
          <div className="flex flex-col items-center gap-3 py-8">
            ...
            <p className="text-sm text-gray-500">맛집 정보를 가져오는 중...</p>
          </div>
        )}

        {status === "success" && (
          <div className="flex flex-col items-center gap-3 py-4">
            <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center animate-bounce-once">
              <span className="text-2xl">🎉</span>
            </div>
            <h3 className="text-base font-bold text-gray-900">잠금 해제 완료!</h3>
            <p className="text-xs text-gray-400">-5P 차감되었습니다</p>
            <button
              onClick={onClose}
        ...
        {status === "error" && (
          <div className="flex flex-col items-center gap-3 py-4">
            ...
            <h3 className="text-base font-bold text-gray-900">오류</h3>
            <p className="text-sm text-gray-500">{errorMsg}</p>
            <button
              onClick={onClose}
              className="mt-2 w-full py-2.5 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition"
            >
              닫기
            </button>
          </div>
